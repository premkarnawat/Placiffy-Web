...
conn_str = f"host=aws-0-ap-south-1.pooler.supabase.com hostaddr=65.0.195.55 port=6543 user=postgres.wkgczwtnxrseiykcrzqj password={password} dbname=postgres sslmode=require"

try:
    conn = psycopg2.connect(conn_str)
    print("Connection successful via hostaddr workaround!")
