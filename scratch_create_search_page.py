...
os.makedirs(r"c:\Users\premk\.gemini\antigravity\playground\ruby-galaxy\app\company\search", exist_ok=True)

search_content = """'use client';
...
with open(r"c:\Users\premk\.gemini\antigravity\playground\ruby-galaxy\app\company\search\page.tsx", "w", encoding="utf-8-sig") as f:
    f.write(search_content)

print("Created global search page")
