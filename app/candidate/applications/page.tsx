  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Track the status of your submitted applications and ATS scores.</p>
      </div>
      ...
      {applications.length === 0 ? (
        <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center">
          ...
          <p className="text-gray-500 mb-6 max-w-md mx-auto">You haven't applied to any jobs yet. Complete your profile and start exploring opportunities.</p>
          <Link href="/candidate/jobs" className="inline-flex bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-2.5 rounded-xl transition-colors">
            Browse Jobs
          </Link>
        </div>
      ) : (
            ...
            <div key={app.id} className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-md transition-shadow">
              <div className="flex flex-col sm:flex-row justify-between gap-4">
                ...
                <div className="flex flex-col items-start sm:items-end gap-3">
                  <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border ${getStatusStyle(app.status)}`}>
