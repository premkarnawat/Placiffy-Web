...
os.makedirs(r"app\candidate\resume-intelligence", exist_ok=True)
...
with open(r"app\candidate\resume-intelligence\page.tsx", "w", encoding="utf-8") as f:
    f.write(page_code)

print("Created /candidate/resume-intelligence/page.tsx UI!")
