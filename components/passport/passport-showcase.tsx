...
import { Shield, CheckCircle, Download, Link2, Award, Check, Clock, Calendar } from 'lucide-react';
    ...
    >
      ...
      >
        <motion.div
          ...
          className="w-full"
        >
          <GlassCard className="border-t-4 border-t-orange-500 p-0 overflow-hidden shadow-2xl relative" glow>
            {/* Header section */}
            <div className="relative p-8 border-b border-slate-900 bg-slate-950/40" style={{ transform: "translateZ(30px)" }}>
            ...
            <div className="flex border-b border-slate-900 px-8 bg-slate-900/10" style={{ transform: "translateZ(15px)" }}>
              <button
            ...
            <div className="p-8 border-t border-slate-900 bg-slate-950/30" style={{ transform: "translateZ(5px)" }}>
